...
```{r P9_download_data_from_github, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r P9_load_raster_lib, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r P9_make_sp_object, message=FALSE, warning=FALSE, paged.print=FALSE, fig.width=8}
...
```{r P9_corrplot, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height = 5, fig.width = 5.25}
...
```{r P9_krig_resid, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r P9_final_map, fig.height=8, fig.width=5}

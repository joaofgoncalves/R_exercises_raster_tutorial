...
Band numbers in the Sentinel-2 satellite differ from its position in the `RasterStack` object
...
```{r P8_plot_b8_b11_b2_S2, fig.height=5.25, fig.width=5, echo=TRUE}

plotRGB(rst, r=7, g=9, b=1, scale=1E5, stretch="lin")

```

![](https://raw.githubusercontent.com/joaofgoncalves/R_exercises_raster_tutorial/master/img/P8_plot_b8_b11_b2_S2.png)

False color Urban: 12 11 4

```{r P8_plot_b12_b11_b4_S2, fig.height=5.25, fig.width=5, echo=TRUE}

plotRGB(rst, r=10, g=9, b=3, scale=1E5, stretch="lin")

```

![](https://raw.githubusercontent.com/joaofgoncalves/R_exercises_raster_tutorial/master/img/P8_plot_b12_b11_b4_S2.png)
...
![](https://raw.githubusercontent.com/joaofgoncalves/R_exercises_raster_tutorial/master/img/P8_load_train_data.png)

...
interest. Stored data can be either: (i) thematic - representing _discrete_ a variable (e.g., 
land us/cover) or _continuous_ (e.g., elevation).
...
Throughout these posts we will cover the basics, the "not-so-basics"" and some advanced stuff in 
__raster data__ handling, manipulation and modelling in R. Examples will be given as well as exercises 
with these different levels will be presented so you can practice.
